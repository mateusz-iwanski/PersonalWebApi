...
namespace PersonalWebApi.Models.Models.Azure
{
    ...
    /// </summary>
    public class ChatHistoryRepositoryCosmosDbDto : CosmosDbDtoBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatHistoryRepositoryCosmosDbDto"/> class.
        /// </summary>
        ...
        public ChatHistoryRepositoryCosmosDbDto(Guid conversationUuid, Guid sessionUuid)
