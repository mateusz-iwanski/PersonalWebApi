...
namespace PersonalWebApi.Services.FileStorage
{
    ...
    public class AzureBlobStorageService : IFileStorageService
    {
        ...
        /// <summary>
        /// Set the name of the container to use.
        /// NameinAzure Blob Storage must be lowercase, automatically converted to lowercase.
        /// It has to be done before any operation. If it's new one, it will create it.
        /// </summary>
        ...
        /// 
        /// If container not exists, it will create it.
        /// </summary>
        ...
        public async Task RemoveFromContainer(string fileName) => await deleteFileAsync(fileName);
        ...
        public async Task<Uri> UploadToContainerAsync(IFormFile file, bool overwrite = false, Dictionary<string, string>? metadata = null, string fileId = "")
        {
            ...
            var uri = await uploadAsync(file, null, overwrite, _containerName, metadata);
            return uri;
        }
